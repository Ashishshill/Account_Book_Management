            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-title mb-4">
                            <div class="d-flex justify-content-start">
                                ...
                                <div class="userData ml-3">
                                    <h2 class="d-block" style="font-size: 1.5rem; font-weight: bold"><a href="javascript:void(0);"><?= $data->employee_name; ?></a></h2>
                                    <h6 class="d-block"><a href="javascript:void(0)"><?= $data->employee_position; ?></a></h6>
                                </div>
                                <div class="ml-auto">
                            ...
                            <div class="col-12">
                                ...
                                <div class="tab-content ml-1" id="myTabContent">
                                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">NID Number</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                <?= $data->employee_nid; ?>
                                            </div>
                        ...
                        <div>
                            <a class="btn btn-success" href="dawonloademployee.php?id=<?= Session::get("employee_id"); ?> ">Dawonload </a>        
                        </div>
                    </div>
